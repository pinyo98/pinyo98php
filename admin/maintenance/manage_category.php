...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "แก้ไข ": "เพิ่ม " ?> โครงการ/รายการ</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="category" class="control-label">ชื่อโครงการ/รายการ</label>
            ...
            <div class="form-group">
                ...
                <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>เปิดใช้งาน</option>
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>ปิดใช้งาน</option>
                </select>
			</div>
