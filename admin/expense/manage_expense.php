...
<form action="" id="expense-form">
    ...
    <div class="form-group">
        <label for="category_id" class="control-label">โครงการ/รายการ</label>
    ...
    <div class="form-group">
        <label for="remarks" class="control-label">หมายเหตุ</label>
...
<script>
	...
	$(document).ready(function(){
        $('.select2').select2({placeholder:"เลือกรายการ",width:"relative"})
		...
		$('#expense-form').submit(function(e){
            ...
            if(parseFloat(amount) > parseFloat(cat_balance)){
                var el = $('<div>')
                    el.addClass("alert alert-danger err-msg mt-2").text("วงเงินงบประมาณมีจำกัดไม่เพียงพอต่อความต้องการ")
